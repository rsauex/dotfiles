...
(define-public powershell
  (package
    ...
    (source (origin (method url-fetch/tarbomb)
                    ...
                    (sha256 (base32 "066lz08gb54v19xy779s0z67iykwyccjfrmvs02qzw02wb6ac9pr"))))
    ...
    (arguments (list #:modules '((guix build utils))
                     #:builder `(begin
                                  ...
                                  (let* ((source (assoc-ref %build-inputs "source"))
                                    ...
                                    (delete-file (string-append pwsh-output "/libcrypto.so.1.0.0"))
                                    (delete-file (string-append pwsh-output "/libssl.so.1.0.0"))
                                          ...
                                          (lambda _
                                            ...
                                            (format #t "export LD_LIBRARY_PATH='~{~a~^:~}'~%"
                                                    (map (lambda (package)
                                                         ...
                                                         '("libunwind" "util-linux" "icu4c" "curl" "openssl" "linux-pam" "lttng-ust")))
